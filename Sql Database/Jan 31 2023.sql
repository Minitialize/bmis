...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 31, 2023 at 03:30 AM
...
--
-- Indexes for table `tbl_resident_house_member`
--
ALTER TABLE `tbl_resident_house_member`
...
ALTER TABLE `tbl_resident_new`
  ...
  ADD UNIQUE KEY `household_member_uk` (`household_member_uk`);
...
--
ALTER TABLE `receipt_transaction`
  MODIFY `recep_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=131;

--
-- AUTO_INCREMENT for table `request_form_information`
--
ALTER TABLE `request_form_information`
  MODIFY `req_form_information_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;

--
-- AUTO_INCREMENT for table `request_form_type`
--
ALTER TABLE `request_form_type`
  MODIFY `req_form_type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=130;
...
--
-- AUTO_INCREMENT for table `tbl_resident_house_member`
--
ALTER TABLE `tbl_resident_house_member`
  MODIFY `household_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
